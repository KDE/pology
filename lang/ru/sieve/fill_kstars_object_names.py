        ...
        if msg.msgctxt == 'Comet name (optional)':
            ...
            if m:
                ...
                tr_name = {
                    ...
                    u'Perrine': u'Перрайн',
                    u'Kowalski': u'Ковальский',
                    u'Garradd': u'Гаррэдд',
                    u'Beshore': u'Бешор',
                    u'Cardinal': u'Кардинал',
                    u'Denning': u'Деннинг',
                    u'Finsler': u'Финслер',
                    u'Harrington': u'Харрингтон',
                    u'Hartwig': u'Хартвиг',
                    u'Holvorcem': u'Ольворсем',
                    u'Humason': u'Хьюмасон',
                    u'Hyakutake': u'Хякутакэ',
                    u'Lagerkvist': u'Лагерквист',
                    u'Larsen': u'Ларсен',
                    u'Pajdusakova': u'Пайдушакова',
                    u'Palomar': u'Паломарская обсерватория',
                    u'Schaumasse': u'Шомасс',
                    u'Schaeberle': u'Шеберле',
                    u'Schwartz': u'Шварц',
                    u'Ikeya': u'Икэя',
                    u'Austin': u'Остин',
                    u'de Vico': u'де Вико',
                    ...
                    u'Larson': u'Ларсон',
                    u'Meier': u'Майер',
                    u'Schweizer': u'Швейцер',
                    u'Wirtanen': u'Виртанен',
                    u'Bruhns': u'Брунс',
                    u'Coggia': u'Коджа',
                    u'Levy': u'Леви',
                    u'La Sagra': u'Ла Сагра',
                    u'Mrkos': u'Мркос',
                    u'Skotti': u'Скотти',
                    u'SWAN': u'SWAN',
                }
